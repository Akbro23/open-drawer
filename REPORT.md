...
- **Demonstration video** — [youtu.be/ys5NUw7-f2Q](https://youtu.be/ys5NUw7-f2Q).
  ...
  the frame.
- **Dataset and fine-tuned checkpoint** — 1024 LeRobot-format demonstrations,
  170,624 frames, and the 10000-step checkpoint §6 is measured on. Both are
  artifacts of the run rather than published files: the dataset is regenerated by
  one command, and the checkpoint is 17 GB and inherits Gemma's terms.
- **This report.**
